...
import com.chosen.cameraview.state.CameraMachine;
...
import com.chosen.cameraview.view.CameraView;
...
/**
 * @author Chosen
 * @create 2018/12/3 11:26
 * @email 812219713@qq.com
 */
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder.Callback,
        CameraView {
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.kf5_camera_ic_camera);
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.kf5_camera_camera_view, this);
        ...
        mCaptureLayout.setCaptureListener(new CaptureListener() {
            ...
            public void recordShort(final long time) {
                mCaptureLayout.setTextWithAnimation(getResources().getString(R.string.kf5_camera_record_short));
        ...
        replaceLayout = view.findViewById(R.id.replace_layout);
    }
    ...
    public void cameraHasOpened() {
        replaceLayout.postDelayed(new Runnable() {
            @Override
            public void run() {
                replaceLayout.setVisibility(GONE);
    ...
    private void setFlashRes() {
        switch (type_flash) {
            case TYPE_FLASH_AUTO:
                mFlashLamp.setImageResource(R.drawable.kf5_camera_ic_flash_auto);
                machine.flash(Camera.Parameters.FLASH_MODE_AUTO);
                break;
            case TYPE_FLASH_ON:
                mFlashLamp.setImageResource(R.drawable.kf5_camera_ic_flash_on);
                machine.flash(Camera.Parameters.FLASH_MODE_ON);
                break;
            case TYPE_FLASH_OFF:
                mFlashLamp.setImageResource(R.drawable.kf5_camera_ic_flash_off);
