...
class DataBaseHelper extends SQLiteOpenHelper {
    ...
    static String DB_TABLE = "kf5chat_message";

    static final String DB_USER = "kf5_chat_user";

    private static final int VERSION = 5;

    static boolean isCreateDb;
    ...
    private void createTable(SQLiteDatabase database) {
        ...
        String sql = "CREATE TABLE IF NOT EXISTS "
                ...
                + DataBaseColumn.IMG_WIDTH + " INTEGER, "
                + DataBaseColumn.IMG_HEIGHT + " INTEGER, "
                + DataBaseColumn.VOICE_DURATION + " INTEGER "
                + ");";
    ...
    private void addChatField(SQLiteDatabase database) {
        ...
        addField(database, DB_TABLE, DataBaseColumn.IMG_WIDTH);
        addField(database, DB_TABLE, DataBaseColumn.IMG_HEIGHT);
        addField(database, DB_TABLE, DataBaseColumn.VOICE_DURATION);
