...
public class JzvdStd extends Jzvd {
    ...
    public void setUp(JZDataSource jzDataSource, int screen) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            fullscreenButton.setImageResource(R.drawable.kf5_videoplay_jz_shrink);
            ...
            changeStartButtonSize((int) getResources().getDimension(R.dimen.kf5_videoplay_jz_start_button_w_h_fullscreen));
        } else if (currentScreen == SCREEN_WINDOW_NORMAL
                || currentScreen == SCREEN_WINDOW_LIST) {
            fullscreenButton.setImageResource(R.drawable.kf5_videoplay_jz_enlarge);
            backButton.setVisibility(View.GONE);
            tinyBackImageView.setVisibility(View.INVISIBLE);
            changeStartButtonSize((int) getResources().getDimension(R.dimen.kf5_videoplay_jz_start_button_w_h_normal));
    ...
    public static final String CLICK_BACK_EVENT = "com.chosen.BACK_BTN_CLICK";
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            if (jzDataSource.urlsMap.isEmpty() || jzDataSource.getCurrentUrl() == null) {
                Toast.makeText(getContext(), getResources().getString(R.string.kf5_videoplay_no_url), Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            backPress();
            v.getContext().sendBroadcast(new Intent(CLICK_BACK_EVENT));
            ...
            final LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.kf5_videoplay_jz_layout_clarity, null);
            ...
            for (int j = 0; j < jzDataSource.urlsMap.size(); j++) {
                ...
                TextView clarityItem = (TextView) View.inflate(getContext(), R.layout.kf5_videoplay_jz_layout_clarity_item, null);
    ...
    public void showWifiDialog() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.kf5_videoplay_tips_not_wifi_confirm), new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(getResources().getString(R.string.kf5_videoplay_tips_not_wifi_cancel), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                clearFloatScreen();
    ...
    public void setBatteryLevel() {
        ...
        if (percent < 15) {
            batteryLevel.setBackgroundResource(R.drawable.kf5_videoplay_jz_battery_level_10);
        } else if (percent >= 15 && percent < 40) {
            batteryLevel.setBackgroundResource(R.drawable.kf5_videoplay_jz_battery_level_30);
        } else if (percent >= 40 && percent < 60) {
            batteryLevel.setBackgroundResource(R.drawable.kf5_videoplay_jz_battery_level_50);
        } else if (percent >= 60 && percent < 80) {
            batteryLevel.setBackgroundResource(R.drawable.kf5_videoplay_jz_battery_level_70);
        } else if (percent >= 80 && percent < 95) {
            batteryLevel.setBackgroundResource(R.drawable.kf5_videoplay_jz_battery_level_90);
        } else if (percent >= 95 && percent <= 100) {
            batteryLevel.setBackgroundResource(R.drawable.kf5_videoplay_jz_battery_level_100);
        }
    }
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            ...
            startButton.setImageResource(R.drawable.kf5_videoplay_jz_click_pause_selector);
            ...
            startButton.setVisibility(VISIBLE);
            startButton.setImageResource(R.drawable.kf5_videoplay_jz_click_replay_selector);
            replayTextView.setVisibility(VISIBLE);
        } else {
            startButton.setImageResource(R.drawable.kf5_videoplay_jz_click_play_selector);
            replayTextView.setVisibility(GONE);
        }
    }
    ...
    public void showProgressDialog(float deltaX, String seekTime, long seekTimePosition, String totalTime, long totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.kf5_videoplay_jz_dialog_progress, null);
        ...
        if (deltaX > 0) {
            mDialogIcon.setBackgroundResource(R.drawable.kf5_videoplay_jz_forward_icon);
        } else {
            mDialogIcon.setBackgroundResource(R.drawable.kf5_videoplay_jz_backward_icon);
        }
    ...
    public void showVolumeDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.kf5_videoplay_jz_dialog_volume, null);
        ...
        if (volumePercent <= 0) {
            mDialogVolumeImageView.setBackgroundResource(R.drawable.kf5_videoplay_jz_close_volume);
        } else {
            mDialogVolumeImageView.setBackgroundResource(R.drawable.kf5_videoplay_jz_add_volume);
        }
    ...
    public void showBrightnessDialog(int brightnessPercent) {
        ...
        if (mBrightnessDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.kf5_videoplay_jz_dialog_brightness, null);
