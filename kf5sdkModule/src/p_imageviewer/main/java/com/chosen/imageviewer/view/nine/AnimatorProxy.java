...
public final class AnimatorProxy extends Animation {
    ...
    /**
     * Whether or not the current running platform need to be proxied
     */
     ...
     * pre-3.0 platforms. <strong>DO NOT</strong> warp your views if you are
