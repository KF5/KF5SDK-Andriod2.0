...
public class AlbumMediaAdapter extends RecyclerViewCursorAdapter<RecyclerView.ViewHolder> implements
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.kf5_album_photo_capture_item, parent, false);
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.kf5_album_media_grid_item, parent, false);
    ...
    private int getImageResize(Context context) {
        if (mImageResize == 0) {
            ...
            int availableWidth = screenWidth - context.getResources().getDimensionPixelSize(
                    R.dimen.kf5_album_media_grid_spacing) * (spanCount - 1);
