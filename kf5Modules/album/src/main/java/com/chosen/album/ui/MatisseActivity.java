...
import com.chosen.album.internal.ui.adapter.AlbumsAdapter;
import com.chosen.album.internal.ui.widget.AlbumsSpinner;
...
public class MatisseActivity extends AppCompatActivity implements
    ...
    private void updateBottomToolbar() {
        ...
        if (selectedCount == 0) {
            ...
            mButtonApply.setText(getString(R.string.kf5_album_button_sure_default));
        } else if (selectedCount == 1 && mSpec.singleSelectionModeEnabled()) {
            mButtonPreview.setEnabled(true);
            mButtonApply.setText(R.string.kf5_album_button_sure_default);
            mButtonApply.setEnabled(true);
        } else {
            mButtonPreview.setEnabled(true);
            mButtonApply.setEnabled(true);
            mButtonApply.setText(getString(R.string.kf5_album_button_sure, selectedCount));
        }
        ...
        if (countOverMaxSize() > 0) {
            ...
            if (mOriginalEnable) {
                IncapableDialog incapableDialog = IncapableDialog.newInstance("",
                        getString(R.string.kf5_album_error_over_original_size, mSpec.originalMaxSize));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_preview) {
            ...
            if (count > 0) {
                IncapableDialog incapableDialog = IncapableDialog.newInstance("",
                        getString(R.string.kf5_album_error_over_original_count, count, mSpec.originalMaxSize));
                incapableDialog.show(getSupportFragmentManager(),
                        IncapableDialog.class.getName());
                return;
            }
