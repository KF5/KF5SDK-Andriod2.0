...
public class JzvdStd extends Jzvd {
    ...
    public void showWifiDialog() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.kf5_videoplay_tips_not_wifi_confirm), (dialog, which) -> {
            dialog.dismiss();
            onEvent(JZUserActionStd.ON_CLICK_START_WIFIDIALOG);
            startVideo();
            WIFI_TIP_DIALOG_SHOWED = true;
        });
        builder.setNegativeButton(getResources().getString(R.string.kf5_videoplay_tips_not_wifi_cancel), (dialog, which) -> {
            dialog.dismiss();
            clearFloatScreen();
        });
