...
//            LogUtil.printf("这里是匹配的值" + m.group(i));
//        }
//        while (m.find()) {
//
//        }
//
//        LogUtil.printf("显示机器人消息");

//        Intent intent = new Intent();
//        intent.putExtra(Field.ID, "这里传分区id，类型是整型");
//        intent.putExtra(Field.TITLE, "这里是分区标题");
//        intent.setClass(getActivity(), HelpCenterTypeActivity.class);
